...
//
// Note: an earlier version of this file also pulled fundamentals (market
// cap, earnings date, net income, profit margin, total cash) from Yahoo's
// separate quoteSummary endpoint. That endpoint turned out to be
// unreliable from a serverless IP (mostly came back empty), and the
// detail pane no longer shows those fields — dropped rather than kept
// around unused.
